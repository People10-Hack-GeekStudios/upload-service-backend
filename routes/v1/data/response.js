const resp = {
  ...
  "upload-exceed" : "Size should not exceed 2MB and the file formats should be (png,jpg,jpeg or bmp). Only 1 file allowed at a time.",
  ...
  "req-rec-should-not-same-type" : "Requester and receiver should not be of same type.",
  ...
  "max-photo-reached" : "Max photo limit reached. Please delete some photo to continue adding.",
  "menu-added" : "Menu added successfully."
}
